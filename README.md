...
Этот MCP не требует дополнительной обвязки, кроме OneScript (и его библиотеки sql), 
...
P.S. Есть более мощный функционально набор скиллов у коллег https://github.com/Nikolay-Shirokov/cc-1c-skills
</human>
